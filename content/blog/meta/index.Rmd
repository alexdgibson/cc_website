...
df %>% 
  ...
  labs(y = "Number of Articles",
       x = "Year") +
  scale_x_continuous(limits = c(2000, 2024), breaks = c(2000, 2004, 2008, 2012, 2016, 2020, 2024))+
  scale_y_continuous(limits = c(0,250))+
  labs(caption = "Figure 1: Published articles per year in PubMed containing 'meta-research' in the title or
abstract. Note: data extracted 2024-11-25")+
