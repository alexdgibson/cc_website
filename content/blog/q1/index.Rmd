...
As each quartile category contains an equal number of journals, it would be correct to assume that publishing in a Q1 journal would indicate that research is among the top 25%.
...
Quality cannot be assessed by a single metric. In the last three years if you were to select a publication at random, you’re most likely to pick an article published in a Q1 journal. Similarly, if you were to select a random publication from a Q1 journal, it is more likely to not be Q1 research than it is.
